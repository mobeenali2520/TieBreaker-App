    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl z-10 relative">
        ...
        <button
          ...
          className="w-full h-12 px-5 bg-white hover:bg-slate-100 text-slate-900 font-semibold rounded-xl flex items-center justify-between gap-3 transition-all shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden border border-slate-200"
        >
          {isConnecting ? (
            <div className="flex items-center justify-center gap-2.5 text-slate-700 text-sm w-full">
